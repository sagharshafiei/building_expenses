...
class LoginView:
    ...
    def __init__(self):
        ...
        self.win.configure(background='Dodgerblue2')
        self.win.resizable(width=False, height=False)

        self.username = LabelAndEntry(self.win, "Username", 20, 20,background='Dodgerblue2')
        self.password = LabelAndEntry(self.win, "Password", 20, 60,background='Dodgerblue2')
